...
let card1 = {
    ...
    subtitle:"Nesta seção você pode definir as metas de faturamento, as margens minimas e máximas com as quais deseja trabalhar e quais produtos podem ou não seguir as indicações do sistema PROFIT MAIS ARTIFICIAL INTELLIGENCE",
...
let card2 = {
    ...
    img:"https://cdn.business2community.com/wp-content/uploads/2019/10/How-To-Improve-Your-CPQ-Pricing-Strategies-image.jpg",
...
let card3 = {
    ...
    subtitle:"Aqui você encontra a lista completa de produtos com o seu respectivo preço, resultado do sistema de pricing PROFIT MAIS. O painel permite a edição direta do preço final e exporta  para o ERP.",
    links:[
